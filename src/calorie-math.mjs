...
export const RECORD_TYPES = [...MEALS, 'snack', 'exercise'];
...
export function difference(record) { return !record ? 0 : record.meal === 'exercise' ? record.calories : record.meal === 'snack' ? -record.calories : record.baseline-record.calories; }
